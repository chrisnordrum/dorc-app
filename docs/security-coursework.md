# DORC — Web Security Fundamentals coursework

> **Archived course deliverable.** This was the original `README.md`, written for the
> SAIT Web Security Fundamentals course. It is kept as the record of the security work
> that went into the first version of DORC, and as the reference for *why* several
> design decisions were made.
>
> It documents the app **as it was submitted** and is no longer maintained as setup
> documentation.
> For how to actually run the project today,
...
![DORC threat model diagram](threat-model.png)
